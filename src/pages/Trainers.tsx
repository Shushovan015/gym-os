        ...
        ? createPortal(
            <AnimatePresence>
              {selectedTrainer && details ? (
                <motion.div className="fixed inset-0 z-[120] flex h-[100dvh] items-center justify-center bg-black/72 p-4 backdrop-blur-sm" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} onClick={() => setSelectedId(null)}>
                  <motion.div
