...
export type InventoryProduct = {
  ...
  inventory_enabled: boolean; cost_price_minor: number; selling_price_minor: number;
...
export type InventoryVariant = {
  ...
  selling_price_minor: number | null; current_quantity: number; low_stock_threshold: number | null;
